...
class LunarHelp {
    ...
    //获得阴历日期某一天的中文
    getLunarDayName() {
        // console.log(this.cDay(this.day));
...
class SimpleCalendar {
    ...
    create() {
        ...
        header.innerHTML = header.innerHTML + '<div class="sc-actions">' +
            ...
            '  </div>';
        header.innerHTML = header.innerHTML + '<div class="sc-actions">' +
            '    <div class="sc-mleft">&lsaquo;</div>' +
            '    <select class="sc-select-month" name=""></select>' +
    ...
    updateSelect(year, month) {
        ...
        // console.log(this.languageData['months_' + this._options.language]);
        for (let i = 0; i < 12; i++) {
    ...
    updateWeek() {
        ...
        weeks.forEach((v, i)=> v.innerHTML = data[i]);
    }
    ...
    addData(year, month) {
        ...
        for (let i = 0; i < 35; i++) {
            ...
            //判断是否添加阴历
            // console.log(this._options.showLunarCalendar);
